...
const TableForRSS = () => {
  ...
  useEffect(() => {
    fetch("Book1.xlsx") // Ensure file is inside `public/` folder
...
function RSSPage() {
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4 text-center bg-white py-2 rounded-xl border border-gray-200 shadow-lg">RSS Summary</h1>
      <TableForRSS />
    </div>
  );
}
